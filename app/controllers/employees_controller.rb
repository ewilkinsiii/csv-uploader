class EmployeesController < ApplicationController
  ...
  def import
    ...
    return redirect_to root_path, alert: "File is not a CSV" unless file.content_type == "text/csv"
  ...
  private
    ...
    def employee_params
      params.require(:employee).permit(:name, :position, :email, :phone, :address, :city, :state, :zip, :salary, :manager, :department, :hire_date, :termination_date, :termination_reason)
    end
end
